...
image:https://img.shields.io/travis/riboseinc/reverse_asciidoctor/master.svg["Build Status", link="https://travis-ci.org/riboseinc/reverse_asciidoctor"]
image:https://codeclimate.com/github/riboseinc/reverse_asciidoctor/badges/gpa.svg["Code Climate", link="https://codeclimate.com/github/riboseinc/reverse_asciidoctor"]
